...
sens_par_name_1 = "Long-run belief heterogeneity ($\bar{\sigma}$)";
sens_par_name_2 = "Short-run belief heterogeneity ($\sigma_{0}$)" ;
...
sens_par_range_1 = 0:0.05:2;
sens_par_range_2 = 2:1:40;
...
%% Parameter setting
        ...
        S                  = sens_par_2                                    ; % Length of planning horizon        (default=20)
        ...
        SigmaMin           = 0.01                            ; % Starting value for sigma_u_H      (default=0.01)
